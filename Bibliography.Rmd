...
Comparison between ML methods for test classification vs traditional psychometric methods. Methods that use decision trees naturally seek interactions between items, while methods that use linear models need you to specify if there is an interaction, otherwise they ignore it. Also, 
